...
type ReadChatMessages = { type: 'READ_CHAT_MESSAGES', chatId: number | string };

export type ChatAction = FetchChatMessages | PutChatMessages | SetMessagesFetchFailedErrorMessage | RecieveChatMessage | ReadChatMessages | any;
...
export const readChatMessages = (chatId: number | string): ReadChatMessages => ({
  type: types.READ_CHAT_MESSAGES,
  chatId: chatId,
});
